...
const BentoCardGrid: React.FC<BentoCardGridProps> = ({ children, gridRef, className = '' }) => (
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef} className={className}>
        {cardData.map((card, index) => {
          ...
          const cardContent = (
            <div className="magic-bento-card__wrapper">
              <div className="magic-bento-card__main">
                {card.label && (
                  <div className="magic-bento-card__badge">
                    <span>{card.label}</span>
                  </div>
                )}
                <div className="magic-bento-card__info">
          ...
          return (
            <div
              ...
              ref={el => {
                ...
                el.addEventListener('mousemove', (e) => handleMouseMove(e as unknown as MouseEvent));
                el.addEventListener('mouseleave', handleMouseLeave);
                el.addEventListener('click', (e) => handleClick(e as unknown as MouseEvent));
              }}
            >
              {cardContent}
            </div>
